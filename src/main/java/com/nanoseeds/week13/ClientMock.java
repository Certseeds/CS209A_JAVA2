...
public interface ClientMock {
    public String sendNameCommand(String s);

    public String sendGradeCommand(String s);

    public String sendTopCommand(String s);

    public String sendUndefinedCommand(String s);
}
